...
let MenuItemFormComponent = class MenuItemFormComponent {
    constructor(formBuilder, menuItemService, router) {
...
let MenuItemListComponent = class MenuItemListComponent {
